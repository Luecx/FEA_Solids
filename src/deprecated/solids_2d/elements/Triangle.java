...
public class Triangle extends FiniteElement2D {
    ...
    public Triangle(Node a, Node b, Node c,double thickness) {
        super(new Node[]{a, b, c}, null, thickness);
        this.a = a;
        this.b = b;
        this.c = c;
    }

    public Triangle(Node a, Node b, Node c,Material material, double thickness) {
        super(new Node[]{a, b, c}, material, thickness);
        this.a = a;
        this.b = b;
        this.c = c;
    }
